...
mod:SetHotfixNoticeRev(20251103203736)
mod:SetMinSyncRevision(20251103203736)
...
local timerSummonValkyr				= mod:NewVarCountTimer("v44.8-48.4", 69037, nil, nil, nil, 1, 71844, DBM_COMMON_L.DAMAGE_ICON, true, 2, 3)
...
local function leftFrostmourne(self)
	...
	timerHarvestSoulCD:Start("v55-61")
