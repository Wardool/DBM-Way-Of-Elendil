...
local spellFlashCountSlider = specArea:CreateSlider(L.SpecWarn_SpellFlashCount, 1, 3, 1, 140)
spellFlashCountSlider:SetPoint("LEFT", check6, "RIGHT", 30, -2)
spellFlashCountSlider.myheight = 0
spellFlashCountSlider:SetValue(math.floor(DBM.Options.SpecialWarningSpellFlashCount or 1))
spellFlashCountSlider:HookScript("OnValueChanged", function(self)
	DBM.Options.SpecialWarningSpellFlashCount = math.floor(self:GetValue())
end)
...
spellFlashCountSlider:ClearAllPoints()
spellFlashCountSlider:SetPoint("TOPLEFT", color0reset, "BOTTOMLEFT", 0, -18)
color0.myheight = 74
...
color1:SetPoint("TOPLEFT", specWarnOne.frame, "TOPLEFT", 20, -52)
...
color2:SetPoint("TOPLEFT", specWarnTwo.frame, "TOPLEFT", 20, -52)
...
color3:SetPoint("TOPLEFT", specWarnThree.frame, "TOPLEFT", 20, -52)
...
color4:SetPoint("TOPLEFT", specWarnFour.frame, "TOPLEFT", 20, -52)
...
color5:SetPoint("TOPLEFT", specWarnFive.frame, "TOPLEFT", 20, -52)
