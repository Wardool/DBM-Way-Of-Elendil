...
mod:RegisterEventsInCombat(
	"SPELL_CAST_SUCCESS 64003 62166 63981 63982", -- 63982 is shockwave
...
local timerNextSmash			= mod:NewCDTimer(15, 64003, nil, "Tank", nil, 5, nil, DBM_COMMON_L.TANK_ICON) -- 3s variance (2022/07/05 log review) - 16.7, 14.4, 14.4, 16.8, 14.4, 14.4 || 13.7, 16.8, 14.4, 14.4, 14.4 || 16.0, 14.3, 16.8, 14.4 || 16.8, 14.4, 14.4, 14.4, 16.8 || 14.1, 14.4, 16.8, 14.4
...
local timerNextShockwave		= mod:NewNextTimer(22.5, 63982, nil, nil, nil, 2) -- (2022/07/05 log review || 25m Lordaeron 2022/10/30) - 25.0 || 25.0, 25.0, 25.0, 25.1
...
function mod:OnCombatStart(delay)
	...
	timerNextShockwave:Start(12-delay) -- (2022/07/05 log review || 25m Lordaeron 2022/10/30) - 19 || 18.2
	timerNextGrip:Start(25-delay) --  (25m Lordaeron 2022/10/30) - 24.2
end
...
function mod:SPELL_CAST_SUCCESS(args)
	...
	if args.IsSpellID(62166, 63981) then -- Stone Grip
		timerNextGrip:Start()
	elseif args.spellId == 63982 then -- Shockwave
...
function mod:SPELL_AURA_APPLIED(args)
	...
	elseif args:IsSpellID(64002, 63355) then	-- Crunch Armor
		...
		timerNextSmash:Start() --  Woe roundabout
		if amount >= 2 then
