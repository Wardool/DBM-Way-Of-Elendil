...
L:SetMiscLocalization({
	HorsemanSummon			= "Horseman rise...", -- CONFIRM! local SQL has different string: Lève-toi, cavalier...
	...
	HitHead					= "Pour que coule mon sang, vous luttez sans faillir. C'est ma tête pourtant, qu'il vous faudra occire."
})
